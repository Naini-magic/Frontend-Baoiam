...
//               {/* Image */}
//               <div className="absolute -top-8 md:-top-10 w-[90px] h-[90px] md:w-[130px] md:h-[130px] rounded-full border-4 border-orange-500 bg-white p-1 z-10">
//                 <img 
//                   src={service.image} 
//                   alt="Service" 
...
//               {/* Card */}
//               <div
//                 className="relative bg-orange-100 text-center px-4 pt-14 pb-12 rounded-lg md:px-6 md:pt-16 md:pb-16 w-full shadow-lg md:shadow-xl shadow-gray-400 md:shadow-gray-500"
//                 style={{ 
